...
SET search_path = production;
	...
	drop table if exists production.dim_pizza;
	create table production.dim_pizza as 
	select 
		a.pizza_id
		,a.pizza_name
		,b.toppings
	...
	create table production.fact_customer_orders as
		select 
			 a.order_id
			,a.order_time
			,a.customer_id
	...
	create table production.dim_runners as 
	select 
		a.runner_id
		,a.registration_date
	from 
	...
	create table production.dim_pizza_toppings as 
	select 
		a.topping_id
		,a.topping_name
	from 
